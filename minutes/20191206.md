...
required “more than 99%”, already incorporated. No immediate action required.
21. Do we support voting via a proxy? Agreed that partipants may vote via a proxy (their sponsor), but the sponsor must 
