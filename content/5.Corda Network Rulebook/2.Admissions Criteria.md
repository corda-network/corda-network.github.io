...
*Please note: this is not a guide to onboarding, but the rules that underpin the process. If you wish to see the onboarding process for Corda Network, please refer to the process guide online: https://corda.network/joining-corda-network/onboarding-workflow which may change from time to time. This should be read together with this Rulebook.*
