...
Each Corda Network Node must have a Corda Network Participation Certificate. Each Corda Network Participation Certificate is identified by its "Legal Name", which consist of legal entity information consistent with that of the Participant. The Legal Name (or X.500 name, as referred below) can contain a maximum of 6 fields that follows the X.500 protocol.
