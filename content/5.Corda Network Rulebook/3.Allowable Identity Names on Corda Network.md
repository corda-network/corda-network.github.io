...
| **State (ST)**              |     N     |             64 | As per above                                                                                     | If the country in which the entity is registered operates a State or Province system (e.g. USA, Australia and Canada) please add the State / Province in which the entity is registered.|
...
It should match the exact name in the government trade registry in which it is registered. This evidence should be recent and not older than 1 year.

If we cannot find evidence of the company through either looking in government trade registers or in trusted 3rd party legal entity databases, our SLA for onboarding will not be breached. You are welcome to send us evidence of the company’s existence, but it must be recent and from a government trade register. We may need to confirm this with our sources.
