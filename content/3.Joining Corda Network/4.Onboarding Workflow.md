...
A member of our team will schedule a call with you to go through the onboarding process. We will also advise you on the network choice and contracting model.
...
i. You will raise a [Task](https://r3-cev.atlassian.net/servicedesk/customer/portal/2/group/2/create/79) ticket on the Corda Network Support Portal. *Note: Your access to the Corda Network Support Portal will be granted after you signed the Corda Network Terms of Use, and your email address needs to be filled out on the Contact Details table on the Terms of Use. If you have any questions or needs access, please contact your account manager.*
...
X.500 name is your node's unique identifier on Corda Network. It consists of the following 6 fields. Check out [Allowable Identity Names](https://corda.network/corda-network-rulebook/allowable-identity-names-on-corda-network) session of the Corda Network Rulebook for detailed guidance of naming your X.500.
...
4. Is the legal entity is on a sanction list observed by Corda Network?

- You can refer to Section 1.2 of the [Admission Criteria](https://corda.network/corda-network-rulebook/admissions-criteria/) for the list of sanction lists observed by Corda Network.

iii. The Corda Network oeprator (R3 currently) will perform due diligence check on the proposed identity name you submitted. This includes:
...
- If you are setting up a notary, there are additional considerations you need to keep in mind, please check [Customer Hub](https://customerhub.r3.com/) for instructions to set up a notary.
...
Step 6.2: Once the above step is completed, you should raise a [Task](https://r3-cev.atlassian.net/servicedesk/customer/portal/2/group/2/create/79) ticket on the Corda Network Support Portal, including a link to the ticket of your pre-approval request. You should raise one ticket per CSR. 
...
A member of the team will review the ticket and approve your CSR accoridngly.
