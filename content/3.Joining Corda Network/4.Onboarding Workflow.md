...
- Node Operator Email is the address used in the node.conf file and will be used for all future communication related to Corda Network, including those involved in identity verification. Please refer to Section 3.4 of the [Allowable Identity Names](https://corda.network/corda-network-rulebook/allowable-identity-names-on-corda-network) in Corda Network Rulebook for more guidance on Node Operator Email.
