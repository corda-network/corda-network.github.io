...
Step 6.2: Once the above step is completed, you should raise a [Onboard a Node (CSR Approval)](https://r3-cev.atlassian.net/servicedesk/customer/portal/7/group/52/create/356) ticket on the Corda Network Support Portal. Follow the instructions to complete the form.

R3 will review your request and approve the CSR accordingly.
