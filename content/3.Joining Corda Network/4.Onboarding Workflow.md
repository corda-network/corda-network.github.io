...
i. You will raise a [Task](https://r3-cev.atlassian.net/servicedesk/customer/portal/2/group/2/create/79) ticket on the Corda Network Support Portal. *Note: Your access to the Corda Network Support Portal will be granted after signing the Corda Network Terms of Use, and your email address needs to be filled out on the Contact Details table on the Terms of Use. If you have any questions or want to request access, please contact your R3 account manager.*
...
iii. The Corda Network operator (R3 currently) will perform due diligence check on the proposed identity name you submitted. This includes:
