...
- You will receive an email outlining how to apply if you are eligible to stand for, or nominate others for the Board. Plesae follow the template at the bottom of the email to apply, or nominate. The application should contain an updated CV, personal statement and short biography of the nominee. 
...
- A legal entity must have 1 node (Open Source / Enterprise) on the network map of the Production environment, by Monday 1 June 2021, to be eligible to participate in the election. (For information about how to onboard a node, please see our [Onboarding Workflow](https://corda.network/joining-corda-network/onboarding-workflow).)
...
- Whether the legal entity owning the node is a direct customer of R3 (signed a Corda Network contract with R3) or a sponsee (covered by their Sponsor’s Corda Network contract with R3), are not relevant. 
...
- Any live legal entities may nominate up to 3 individuals for the Board, however in the end its likely only 1 will get through, according to the diversity criteria in Section 4 of the [Foundation's By-Laws](https://corda.network/corda-network-foundation/by-laws).
