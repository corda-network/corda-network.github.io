...
Corda Network has it's own [Trust Root](content/2.Corda-Network-Foundation/5.Trust-Root) -- the single, long-term cryptographic key which all the certificates on the Network root back to, and is the basis of trust in the provenance of data, recognised by  participants. For Corda Network, this is offline and secured in custody by the Corda Network Foundation.


## Identity Manager

The Identity Manager admits new participants onto Corda Network. The service receives certificate signing requests (CSRs) from prospective network participants (sometimes via a [Sponsor](content/3.Joining-Corda-Network/2.Contracting-Model)) and reviews the information submitted. 
...
If you have questions about any of the above, and can't find your answer on this site, [contact us](content/1.about/4.contact)!
