...
Service Operators shall seek prior approval from the Network Operator prior to implementing any changes which would violate the backward compatibility principle (see 1.3).
