...
Please note that the terms of this Pre-Production Service Level Agreement (SLA) are subject to change. Participants will be notified of any material changes via the contact contained in the Certificate Signing Request for each node unless alternative contact details are advised.

## Contents

- [1. Pre-Production Definitions](#1-pre-production-definitions)
- [2. Pre-Production Introduction](#2-pre-production-introduction)
  - [2.1. Pre-Production Scope](#21-pre-production-scope)
  - [2.2. Pre-Production Assumptions](#22-pre-production-assumptions)
  - [2.3. Pre-Production Support](#23-pre-production-support)
- [3. Pre-Production Service Levels](#3-pre-production-service-levels)
  - [3.1. Pre-Production Availability](#31-pre-production-availability)
    - [3.1.1. Pre-Production Identity Manager](#311-pre-production-identity-manager)
    - [3.1.2. Pre-Production Network Map](#312-pre-production-network-map)
    - [3.1.3. Pre-Production Notary](#313-pre-production-notary)
  - [3.2. Pre-Production Performance](#32-pre-production-performance)
    - [3.2.1. Pre-Production Identity Manager](#321-pre-production-identity-manager)
    - [3.2.2. Pre-Production Network Map Service](#322-pre-production-network-map-service)
    - [3.2.3. Pre-Production Notary](#323-pre-production-notary)
  - [3.3. Pre-Production Exclusions](#33-pre-production-exclusions)
- [4. Pre-Production Change Management](#4-pre-production-change-management)
  - [4.1. Pre-Production Ongoing Maintenance](#41-pre-production-ongoing-maintenance)
  - [4.2. Pre-Production Network Infrastructure Patching](#42-pre-production-network-infrastructure-patching)
  - [4.3. Pre-Production Emergency Maintenance](#43-pre-production-emergency-maintenance)
  - [4.4. Pre-Production Platform Upgrades](#44-pre-production-platform-upgrades)
  - [4.5. Pre-Production Network Parameter Updates](#45-pre-production-network-parameter-updates)
  - [4.6. Pre-Production Scheduled Downtime](#46-pre-production-scheduled-downtime)
  - [4.7. Pre-Production Unscheduled Downtime](#47-pre-production-unscheduled-downtime)
  - [4.8. Pre-Production Change Freezes](#48-pre-production-change-freezes)
- [5. Pre-Production Business Continuity](#5-pre-production-business-continuity)
  - [5.1. Pre-Production Backups](#51-pre-production-backups)
  - [5.2. Pre-Production Data Retention](#52-pre-production-data-retention)
  - [5.3. Pre-Production Recovery Time Objective](#53-pre-production-recovery-time-objective)
  - [5.4. Pre-Production Recovery Point Objective](#54-pre-production-recovery-point-objective)
- [6. Pre-Production Reporting and Service Credits](#6-pre-production-reporting-and-service-credits)
  - [6.1. Pre-Production Reporting](#61-pre-production-reporting)
  - [6.2. Pre-Production Service Credits](#62-pre-production-service-credits)


## 1. Pre-Production Definitions
...
### 2.2. Pre-Production Assumptions
...
### 2.3. Pre-Production Support

- The Network Operator supports Corda Network Services according to the service levels documented in the Support Handbook found on the [Corda Network website](https://corda.network).

## 3. Pre-Production Service Levels
...
### 3.1. Pre-Production Availability

Definitions of availability for each service are included below.

#### 3.1.1. Pre-Production Identity Manager
...
#### 3.1.2. Pre-Production Network Map
...
### 3.2. Pre-Production Performance

#### 3.2.1. Pre-Production Identity Manager
...
## 4. Pre-Production Change Management

All changes to Corda Network infrastructure are communicated via the Network Operator’s [service dashboard](https://corda-network.statuspage.io/), which will automatically send notifications for the scheduling and progress of each change to node operators via the contact contained in the CSR for each node unless alternative contact details are advised.

### 4.1. Pre-Production Ongoing Maintenance
...
### 4.2. Pre-Production Network Infrastructure Patching

Infrastructure patches are applied on a recurring monthly schedule. These activities are usually low risk and non-service impacting. Details of the change, including the relevant change windows, will be communicated a **minimum of five (5) business days in advance** via the Network Operator’s service dashboard.

### 4.3. Pre-Production Emergency Maintenance

On occasion, emergency maintenance may be required in response to a real or perceived vulnerability, security threat or unexpected service disruption. Emergency maintenance will be communicated as soon as practicably possible via the Network Operator’s service dashboard.

### 4.4. Pre-Production Platform Upgrades
...
### 4.5. Pre-Production Network Parameter Updates
...
### 4.6. Pre-Production Scheduled Downtime

In the event that any platform maintenance or upgrades require a period of service impacting scheduled downtime, Participants will be notified by the Operator a **minimum of one (1) calendar month in advance** of the planned change window.

### 4.7. Pre-Production Unscheduled Downtime

All reasonable attempts will be made to avoid such unscheduled downtime, however on occasion emergency system maintenance may be required. For example, this could be to mitigate real or perceived security threats requiring immediate action, or in order to prevent more severe disruption to services as the result of a service incident. Emergency maintenance will be communicated as soon as practicably possible via the Network Operator’s service dashboard.

Any unavailability of services during normal business hours will be treated as an incident and managed according to the service levels defined in the Corda Network Support Handbook.

### 4.8. Pre-Production Change Freezes
...
## 5. Pre-Production Business Continuity

The Corda Network has a disaster recovery policy which is reviewed and tested semi-annually. This is in addition to a comprehensive security policy incorporating specific security incident management procedures to ensure business continuity in the event of an unexpected incident or system failure.

### 5.1. Pre-Production Backups
...
### 5.2. Pre-Production Data Retention
...
### 5.3. Pre-Production Recovery Time Objective
...
### 5.4. Pre-Production Recovery Point Objective
...
## 6. Pre-Production Reporting and Service Credits

### 6.1. Pre-Production Reporting
...
### 6.2. Pre-Production Service Credits
