...
Summary Table
-------------
This is intended to provide a high level overview. A more detailed description is outlined below.
...
| 4.2 | *Pick a Distinguished Name* - all nodes on Corda Network must have a Distinguished Name (DN) in their [participation certificate](https://docs.corda.net/corda-network/index.html#identity-service).
...
| 6   | **Terms of Use** - the Terms of Use is a non-commercial legal document around network behaviour. It is available as a click-through agreement which will provide direct confirmation of acceptance to the Corda Network Operator. Available here: [Terms of Use](https://fs22.formsite.com/r3cev/CordaUATAgreement2019/index.html)                                                                                                                                                                                                                                                                            | The production Terms of Use for direct signing is [available here](https://corda.network/participation/terms-of-use.html) |
