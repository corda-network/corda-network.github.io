...
| Segregated Network    | - Node identities not visible to Mainnet. <br/>- Control over network parameter upgrades.  <br/>- Lower effort and time to set-up; transaction is free.  | - Less control than a private network. <br/>- Time, effort and cost to set-up and operate the private notary.                                                              |
